...
//     * @return
//     */
//    public boolean lPushAll(String key, Object... values) {
//        try {
...
//     * @return
//     */
//    public boolean lPushAll(String key, Collection values) {
//        try {
//            redisTemplate.opsForList().leftPushAll(key, values);
//            return true;
//        } catch (Exception e) {
...
//    }
//
//    public <T> List<T> popData(int total, String redisList) {
//        List<T> list = new ArrayList<T>();
//
//        int i = total;
//        while (i > 0) {
//            i = i - 1;
//            T vo = (T) (this.rPop(redisList));
//            if (vo != null) {
//                list.add(vo);
//            } else {
//                // 取出来为空的情况下 这里直接退出
