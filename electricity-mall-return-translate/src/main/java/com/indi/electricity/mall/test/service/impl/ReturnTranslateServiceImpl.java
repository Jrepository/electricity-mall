...
public class ReturnTranslateServiceImpl implements IReturnTranslateService {
    ...
    public List<TranslateVo> getTranslateVoList() {
        ...
        //children=[{id=13}],parent=null
        list.add(new TranslateVo(12, 0, 1, 1));
        //children=[{id=14},{id=15}],parent={id=12}
        list.add(new TranslateVo(13, 12, 0, 2));
        //children=[],parent={id=13}
        list.add(new TranslateVo(15, 13, 1, 3));
        return list;
    }
}
